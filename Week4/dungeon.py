...
def examine_throne_hall(gold_coins: int) -> None:
    ...
    print_gold_amount(gold_coins)
    rob_amount = 40
    print("You disturb the dungeon keeper who makes you pay " , int(rob_amount) , " gold.")
...
def print_gold_amount(gold_coins: int) -> None:
    ...
    print("You have ", (gold_coins) , " gold.")
...
def go_to_kitchen(gold_coins: int) -> None:
    ...
    if option == 0:
        ...
        go_to_kitchen(gold_coins + option*wash_dishes_amount)
